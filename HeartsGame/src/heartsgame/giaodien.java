...
public class giaodien extends JFrame {
    ...
    public giaodien(final gameEngine ge) {
        ...
        setVisible(true);
        //setSize(xresolusion, yresolusion);
        setBounds(300, 100, xresolusion, yresolusion);
    ...
    void setnomal(int currentturn, int cardClicked) {
        setnomal(cardClicked);
    }

    void sethightlight(int currentturn, int cardClicked) {
