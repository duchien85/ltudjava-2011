...
public class gameEngine implements Runnable {
    ...
    public void processEndRound() {
        ...
        currentstep = GameDef.GAME_PLAY_END;
    ...
    public void receiveClick(int cardClicked) {
        if (currentstep == GameDef.GAME_PLAY_EXCHANGE) { //step1: hoan doi bai
            HoanDoiBai(cardClicked);
        } else {
            if (currentstep == GameDef.GAME_PLAY_PLAYING) {//step 2:play
                GamePlay(cardClicked);
            } else {//step 3
                newRound();
            }
        }
    ...
    public void HoanDoiBai(int cardClicked) {
        if (cardClicked != 0) { //click vao 1 la bai
            ...
            if (player[0].threeCard.size() == 3
                ...
                gdien.notice("Tat ca nguoi choi chua chon bai xong !!!");
            }
        }
    }

    public void GamePlay(int cardClicked) {
